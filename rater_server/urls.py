"""rater_server URL Configuration
...
from rater_api.views.ratings import RatingView
...
router.register(r'ratings', RatingView, 'game_rating')
...
urlpatterns = [
    ...
    path('', include('rater_reports.urls'))
]
